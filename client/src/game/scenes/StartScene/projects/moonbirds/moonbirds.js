...
function setUpYourPlanet() {
    ...
    // CHANGE VARIABLES
    const planetName = "MOONBIRDS"; // UPPERCASE

    const mapType = "ISLAND"; // id = 2 - apartments, id = 3 - island, id = 4 - cafe

    const planetTexture = 'moonbirds-planet'; // example: coffeebar-planet

    const token_address = "0x59E1faC2FAF72765AD41aE1BfAC53d5cd80acB91"; // address of your NFT collection
...
export function moonbirds(self, Moralis) {
